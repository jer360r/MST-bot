...
╭───────────⍟
├🤖 𝙼𝚈 𝙽𝙰𝙼𝙴 : {}
├👑 𝙾𝚆𝙽𝙴𝚁 : <a href=https://t.me/PYRO_BOTZ>MICRO𝗕𝗢𝗧𝗭</a> 
├👨‍💻 𝙿𝚁𝙾𝙶𝚁𝙰𝙼𝙴𝚁 : <a href=https://github.com/jer360r/MST_Renamer-Bot>MICRO 𝚃𝙴𝙲𝙷.𝚐𝚒𝚝</a>
...
•> /start the bot and send any picture to the Bot.Bot automatically set thumbnile.
...
•> send any file and click rename option. Type new file name and send select [ document, video, audio ]👈 choice this.
